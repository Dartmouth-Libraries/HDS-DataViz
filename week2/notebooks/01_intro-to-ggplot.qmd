...
For experienced users of R who regularly share their code with other researchers and experiment with others' code, we recommend setting up a separate **virtual environment** for each project. The recommended tool for doing this is the [renv](https://rstudio.github.io/renv/) package.
