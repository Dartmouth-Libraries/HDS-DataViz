...
# Tidy Weather: Data Wrangling for Visualization, Part 2
...
df20c_avgs <- df20c |>
    group_by(MON, DAY) |>
    summarise(
        Avg_TMAX_20c = mean(TMAX, na.rm = TRUE),
...
ggplot(df_2024, aes(
    ...
    labs(title = "2024 Daily Max Temperature Difference from 20th Century Average",
       x = "Day of Year (2024)",
...
::: callout-tip
# CODING ASSIGNMENT Week 2, Notebooks 03-03b: Visualizing Weather Data
...
4.  **To complete this assignment: Create a brief, clean version of your Quarto document (removing all unnecessary code). Then submit a pdf version of this document to CANVAS. To convert the document into a pdf see the directions below.**
