...
Before trying to create our own personalized theme, however, let's try to create a theme using an existing style guide, that of the *Urban Institute*. Note: the Urban Institute has already done this using [urbnthemes](https://urbaninstitute.github.io/urbnthemes/) package, but we will recreate this theme from scratch.
