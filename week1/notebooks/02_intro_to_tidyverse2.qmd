...
5.  **To complete this assignment: Create a brief, clean version of this Quarto document (removing all unnecessary code). Then submit a pdf version of this document to CANVAS. To convert the document into a pdf see the directions below.**
6.  Instructions for converting a Quarto Document (.qmd) into a PDF (for more details see [Quarto: pdf basics](https://quarto.org/docs/output-formats/pdf-basics.html)):
